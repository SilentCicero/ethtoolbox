...
},{"./lib/hash":"node_modules/hyperapp-styled-components/src/lib/hash.js","hyperapp":"node_modules/hyperapp/src/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var state = {
  ...
  error: null,
  results: ['Welcome to EthToolBox brought to you by Ethers.js, the Eth Community and Nick Dodson ;)', 'Tip: you can access Ethers directly using Eval e.g. ethers.utils.bigNumberify("12").toHexString()'],
  errors: []
};
...
var actions = {
  ...
  eval: function _eval() {
    return function (state, actions) {
      try {
        actions.result("eval(\"".concat(state.inputB || '', "\") => ").concat(eval(state.inputB || '')));
      } catch (error) {
        actions.error(error);
      }
    };
...
var abiEncode = encodePacked; // lower case it
...
var TextArea = _hyperappStyledComponents.default.textarea(_templateObject3());
...
var Code = function Code() {
  return function (state, actions) {
    ...
    }, (0, _hyperapp.h)("i", null, "built with ", (0, _hyperapp.h)("a", {
      href: "https://github.com/ethers-io/ethers.js",
      target: "_blank"
    }, "ethers.js"))), (0, _hyperapp.h)("div", null, (0, _hyperapp.h)("br", null), (0, _hyperapp.h)("h4", null, "String & Hex Tools"), (0, _hyperapp.h)("div", {
    ...
    }, "Wei"))), (0, _hyperapp.h)(Column, null, (0, _hyperapp.h)("h3", null, "Current Unix Timestamp"), (0, _hyperapp.h)("div", null, Math.round(new Date().getTime() / 1000), " ", (0, _hyperapp.h)("small", {
      style: "cursor: pointer; user-select: none;",
      onclick: function onclick(e) {
        return actions.change({});
      }
    }, "refresh")))), (0, _hyperapp.h)(Results, null, state.results.concat(state.errors).reverse().map(function (v, i) {
      return (0, _hyperapp.h)("div", {
...
//# sourceMappingURL=/ethtoolbox.e31bb0bc.map